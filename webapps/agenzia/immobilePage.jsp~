...
<script type="text/javascript"> function controlloLogin() {
         var nameuser = document.forms["login"]["user"].value; 
         if ( nameuser == "Username") { alert("Inserire nome utente e password!");
         return false; } } 
</script> 

<script type="text/javascript"> function controlloOfferta() { 
        var offerta = document.forms["faiOfferta"]["CifraOfferta"].value; 
        var NomeUser = document.forms["faiOfferta"]["Nome"].value; 

         var CognomeUser = document.forms["faiOfferta"]["Cognome"].value; 
         var TelefonoUser = document.forms["faiOfferta"]["Telefono"].value; 
         var CifraOfferta = document.forms["faiOfferta"]["Telefono"].value; 
         if( NomeUser == "Inserisci nome" || CognomeUser == "Inserisci cognome" || TelefonoUser == "Inserisci telefono" || 
                                            CifraOfferta == "Insersci cifra offerta")
 ...
 <!--***** FORM PER IL LOGIN   ****-->
    <div id="col1">
	      <div class="login-card">
		      ...
		      <form name="login" action="./main" method="post" onsubmit="controlloLogin()"> 
	      ...
	      <div class="login-card">
		      ...
		      <form name="faiOfferta" action="./main" method="post" onsubmit="controlloOfferta()">
                ...
                <input type = "hidden" name = "idTent" value = "<%= bean.getIdTent() %>" >
