	...
	CREATE TABLE Offerta(
		...
		FOREIGN KEY(NomePA, CognomePA, GiornoContattoPA, TelefonoPA) 
              		REFERENCES PotenzialeAcquirente(Nome, Cognome, GiornoContatto, Telefono)
                  	ON DELETE SET DEFAULT
                 	ON UPDATE CASCADE,

		PRIMARY KEY( IdTentativoVendita, PrezzoOfferto, NomePA, CognomePA, GiornoContattoPA, TelefonoPA),
